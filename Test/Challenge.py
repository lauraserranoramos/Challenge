...
print('average length of the text', average_length(df['web_page_content']))
...
print('percentage', df['sentiment_category_polarity'].value_counts(normalize=True) * 100)
...
print('Percentage', vaders['polarity'].value_counts(normalize=True) * 100)